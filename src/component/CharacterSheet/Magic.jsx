        ...
        if (this.state.revealed) {
            render = (<div>
                ...
                <div
                    ...
                    <div className="Container">
                        ...
                        <div
                            ...
                            <p className='Spell'>8<p className='sup'>th</p></p>
                            <p className='Spell'>{magic_userSpells[7]}</p>
                        </div>
                        <div
                            style={{display: magic_userSpells[8] ? '' : 'none'}}>
                            <p className='Spell'>9<p className='sup'>th</p></p>
                ...
                <div
                    ...
                    <p className='Smalltext' style={{marginLeft: 5}}>Skeleton: {turnClass.turn_undead[0]}</p>
                    <p className='Smalltext' style={{marginLeft: 5}}>Zombie: {turnClass.turn_undead[1]}</p>
                    <p className='Smalltext' style={{marginLeft: 5}}>Ghoul: {turnClass.turn_undead[2]}</p>
                    <p className='Smalltext' style={{marginLeft: 5}}>Shadow: {turnClass.turn_undead[3]}</p>
                    <p className='Smalltext' style={{marginLeft: 5}}>Wight: {turnClass.turn_undead[4]}</p>
                    <p className='Smalltext' style={{marginLeft: 5}}>Ghast: {turnClass.turn_undead[5]}</p>
                    <p className='Smalltext' style={{marginLeft: 5}}>Wraith: {turnClass.turn_undead[6]}</p>
                    <p className='Smalltext' style={{marginLeft: 5}}>Mummy: {turnClass.turn_undead[7]}</p>
                    <p className='Smalltext' style={{marginLeft: 5}}>Spectre: {turnClass.turn_undead[8]}</p>
                    <p className='Smalltext' style={{marginLeft: 5}}>Vampire: {turnClass.turn_undead[9]}</p>
                    <p className='Smalltext' style={{marginLeft: 5}}>Ghost: {turnClass.turn_undead[10]}</p>
                    <p className='Smalltext' style={{marginLeft: 5}}>Lich: {turnClass.turn_undead[11]}</p>
                    <p className='Smalltext' style={{marginLeft: 5}}>Fiend: {turnClass.turn_undead[12]}</p>
                </div>
            </div>)
        } else {
            render = (<div>
